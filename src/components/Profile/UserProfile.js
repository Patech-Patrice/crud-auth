...
import Dashboard from './../../FigmaComponents/Dashboard.js'
...
const UserProfile = () => {
  return (
    <div className='ReactDemoLandingPage_ReactDemoLandingPage'>
      <div className='Asset21'>
       
      <div className='StripPatterns'>
				<div className='Rectangle7'/>
				<div className='Rectangle7Copy8'/>
				<div className='Rectangle7Copy12'/>
				<div className='Rectangle7Copy10'/>
				<div className='Rectangle7Copy15'/>
				<div className='Rectangle7Copy4'/>
				<div className='Rectangle7Copy16'/>
				<div className='Rectangle7Copy17'/>
				<div className='Rectangle7Copy9'/>
				<div className='Rectangle7Copy14'/>
				<div className='Rectangle7Copy5'/>
				<div className='Rectangle7Copy6'/>
				<div className='Rectangle7Copy7'/>
			</div>
    ...
    {/* <div className='Behance'>
					...
					<img alt='' className='Vector_4' src = {ImgAsset.ReactDemoLandingPage_Vector_4} />
				</div>
        ...
        <div className='Group'>
				<div className='OBJECTS'>
					...
					<div className='Group_37'>
						<div className='Group_38'>
							<img alt='' className='Rectangle_28' src = {ImgAsset.SignUp_Rectangle_9} />
						</div> 

				 <div className='Group_39'>
							<img alt='' className='Rectangle_29' src = {ImgAsset.SignUp_Rectangle_10} />
							<div className='Group_40'>
								<img alt='' className='Rectangle_30' src = {ImgAsset.SignUp_Rectangle_11} />
							</div>
						</div>
